...
class CustomColorScheme extends ColorScheme {
  static const Color customPrimaryColor = Color.fromARGB(255, 0, 0, 0);
  ...
  static const Color customOnSecondaryColor = Color.fromARGB(244, 255, 255, 255);
  static const Color customBackgroundColor = Color.fromARGB(255, 255, 255, 255);
...
Map<String, ColorScheme> customThemes = {
  ...
  "Paragraph": const CustomColorScheme(
    ...
    onSecondary: Color.fromARGB(255, 82, 25, 25),
    background: Color.fromARGB(255, 128, 26, 26),// main background
